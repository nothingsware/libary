...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
        TextFont = "Default",
			  TextColor = Color3.fromRGB(240, 240, 240), -- Adjusted text color

        Background = Color3.fromRGB(25, 25, 25),
        Topbar = Color3.fromRGB(34, 34, 34),
        Shadow = Color3.fromRGB(20, 20, 20),

        -- Adjusted base gray on transparency
        NotificationBackground = Color3.fromRGB(20, 20, 20),
        NotificationActionsBackground = Color3.fromRGB(230, 230, 230, 0.8), -- Adjusted transparency
        ...
        PlaceholderColor = Color3.fromRGB(240, 240, 240) -- Adjusted placeholder color
    },
		Light = {
